              ...
              @foreach($tournament as $row)
                <tr>
                    ...
                    <td> 
                        ...
                        <a href="" data-id="<?= $row['id'] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-success   
                             btn-sm  toggle_btn_a">
                             Accepted
                      </a>
                    </td>  
                    @else
                    <td>
                       <a href="" data-id="<?= $row['id'] ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-danger   
                             btn-sm  toggle_btn_a">
                             Declined
                      </a>
                    </td>  
                    @endif
                    <td> 
                      <a href="{{url('/tournament_players', $row->id)}}" class="btn text-white btn-sm" style="background: #4675A9">
                          view
                      </a>
                    </td>  
                </tr>
